...
final class DrinkUploadViewModel: ObservableObject {
    ...
    func mapFirebaseDrink(drinkType: DrinkJsonType) -> [FBDrink]? {
        ...
        let agePreference = ["20": 0, "30": 0, "40": 0, "50": 0]
        ...
        case .beer:
            ...
            return drinkData.map {
                FBDrink(category: $0.category, type: $0.type, name: $0.name, amount: $0.amount,
                        ...
                        wellMatched: $0.wellMatched, rating: 0, taggedPostID: [], agePreference: agePreference,
        ...
        case .traditional:
            ...
            return drinkData.map {
                FBDrink(category: $0.category, type: $0.type, name: $0.name, amount: $0.amount,
                        ...
                        sweet: $0.sweet, sour: $0.sour, refresh: $0.refresh, body: $0.body, carbonated: $0.carbonated, material: $0.material,
                        wellMatched: $0.wellMatched, rating: 0, taggedPostID: [], agePreference: agePreference,
                        genderPreference: genderPreference)
            }
        case .whiskey:
